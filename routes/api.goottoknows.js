...
var fs              = require('fs');
//========================================================
var GootToKnows = require('./models/GootToKnows.js');
...
exports.list = function (req, res) {
  'use strict';
  GootToKnows.find(function(err, response) {
    if (err) {
      res.send(err);
    }
...
exports.edit = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    GootToKnows.findOne({ _id : id }, function(err, response) {
      if (err) {
        res.send(false);
      }
      // изменяем поля
...
exports.add = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    // новый объект
    var newItem = new GootToKnows(req.body);
    // пробуем записать
...
exports.delete = function (req, res) {
  ...
  var id = req.params.id;
  console.log(id);
  GootToKnows.remove({_id: id}, function(err, data){
    if (err) {
      res.json(false);
    }
    console.log(data);
