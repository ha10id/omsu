...
var fs              = require('fs');
//========================================================
var PortalDev = require('./models/PortalDev.js');
...
exports.list = function (req, res) {
  'use strict';
  PortalDev.find(function(err, response) {
    if (err) {
      res.send(err);
    }
...
exports.edit = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    PortalDev.findOne({ _id : id }, function(err, response) {
      if (err) {
        res.send(false);
      }
      // изменяем поля
...
exports.add = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    // новый объект
    var newItem = new PortalDev(req.body);
    // пробуем записать
...
exports.delete = function (req, res) {
  ...
  var id = req.params.id;
  console.log(id);
  PortalDev.remove({_id: id}, function(err, data){
    if (err) {
      res.json(false);
    }
    console.log(data);
