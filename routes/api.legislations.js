...
var fs              = require('fs');
//========================================================
var Legislations = require('./models/Legislations.js');
...
exports.list = function (req, res) {
  'use strict';
  Legislations.find(function(err, response) {
    if (err) {
      res.send(err);
    }
...
exports.edit = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    Legislations.findOne({ _id : id }, function(err, response) {
      if (err) {
        res.send(false);
      }
      // изменяем поля
...
exports.add = function (req, res) {
  ...
  // if (req.session.authorized) {
    ...
    // новый объект
    var newItem = new Legislations(req.body);
    // пробуем записать
